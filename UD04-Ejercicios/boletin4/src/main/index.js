...
let c1 = new Coche ( "9999ABC", 150);
console.log(c1._matricula);
c1.ofrecerAsistencia();

let m1 = new Moto ( "2222ABC", 20);
...
let cx1 = new ContaXestionada ("Xoan Perez", 500);
let saldoComision = ContaXestionada.comision(cx1._saldoInicial);
console.log ("saldo Actual" + saldoComision);